          ...
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-8 shadow-2xl relative overflow-hidden">
            ...
            <form onSubmit={handleLoginSubmit} className="space-y-5">
              ...
              <button
                ...
                className="w-full py-4 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-2xl transition-all shadow-lg shadow-blue-600/30 flex items-center justify-center gap-2 text-base mt-2 cursor-pointer disabled:opacity-50"
              >
      ...
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-4 max-w-7xl mx-auto w-full mb-8">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center justify-center gap-2 bg-slate-900 hover:bg-slate-800 text-slate-200 border border-slate-800 font-bold px-4 py-2.5 rounded-xl transition-colors text-sm cursor-pointer disabled:opacity-50"
          >
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 bg-red-600/20 hover:bg-red-600/30 text-red-400 border border-red-500/30 font-bold px-4 py-2.5 rounded-xl transition-colors text-sm cursor-pointer"
          >
